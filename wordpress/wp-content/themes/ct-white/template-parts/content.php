	...
	<header class="entry-header">
		...
		<div class="post-container row">
				...
				<a href="<?php the_permalink() ?>">
					<?php
						if (has_post_thumbnail()) {
							the_post_thumbnail('ct_white_thumb');
						} else { ?>
			...
			<div class="post-content col-md-8">
				<?php the_title( sprintf( '<h2 class="entry-title"><a href="%s" title="%s">', esc_url( get_permalink() ), esc_attr(get_the_title() ) ), '</a></h2>' ); ?>
			...
			<footer class="entry-footer">
				<a href="<?php the_permalink(); ?>" class="more-link"><?php _e('Read More', 'ct-white'); ?></a>
