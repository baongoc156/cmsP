...
<div class="wrapper-info">
	<div class="col-left">
		...
		<div class="color_bg_blue">
			...
			<div class="coupon-code"><?php esc_html_e( 'Get', 'mega-construction' ); ?> <span><?php esc_html_e( '20% off', 'mega-construction' ); ?></span> <?php esc_html_e( 'on Premium Theme with the discount code: ', 'mega-construction' ); ?> <span><?php esc_html_e( '" Get20 "', 'mega-construction' ); ?></span></div>
		</div>
		<div class="started">
