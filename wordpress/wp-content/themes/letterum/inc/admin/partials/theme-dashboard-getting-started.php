...
<div class="tab-section">
    <h3 class="section-title"><?php esc_html_e( 'What\'s new?', 'letterum' ); ?></h3>
    <p><?php esc_html_e( 'Since v1.3, the theme offers its block patterns.', 'letterum' ); ?></p>
</div><!-- .tab-section -->
...
<ul>
	...
	<li>
		<?php
        // Display link to plugin page.
        printf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( $getting_started_links['getwid'] ), esc_html__( 'Getwid', 'letterum' ) );
		?>
	</li>
</ul>
</div><!-- .tab-section -->
