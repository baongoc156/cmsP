 ...
 */
class shapro_nav_walker extends Walker_Nav_Menu {	
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li class="menu-item"><a class="nav-link add-menu" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add a menu', 'shapro' ) . '</a></li>';
			$fb_output .= '</ul>';
