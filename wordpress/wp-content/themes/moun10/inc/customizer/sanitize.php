...
if ( ! function_exists( 'moun10_sanitize_select' ) ) :
	/**
	 ...
	 */
	function moun10_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'moun10_sanitize_image' ) ) :
	/**
	 ...
	 */
	function moun10_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'moun10_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function moun10_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'moun10_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Moun10 1.0.0
	*/
	function moun10_sanitize_page( $input ) {
...
if ( ! function_exists( 'moun10_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Moun10 1.0.0
	 ...
	 */
	function moun10_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'moun10_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Moun10 1.0.0
	 */
	function moun10_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'moun10_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Moun10 1.0.0
	 */
	function moun10_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'moun10_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function moun10_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function moun10_sanitize_switch_control( $input ) {
...
if ( ! function_exists( 'moun10_sanitize_sortable' ) ) :
	/**
	...
	* @since Moun10 1.0.0
	*/
	function moun10_sanitize_sortable( $input ) {
 ...
 */
function moun10_sanitize_html( $html ) {
