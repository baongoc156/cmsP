 ...
 */
class Moun10_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Moun10_Dropdown_Category_Control extends WP_Customize_Control {
...
class Moun10_Note_Control extends WP_Customize_Control {
...
class Moun10_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Moun10_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="moun10-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Moun10_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="moun10-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Moun10_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Moun10_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="moun10-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="moun10-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu moun10-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="moun10-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Moun10_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Moun10_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
